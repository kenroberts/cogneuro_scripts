...
root_dir = 'H:\Color_Change_Pilot\LOG\';

% SubjectID field, can be any string (a number or a name, or a code word)
SubjectID = {'1091'}; % edit the number of subjects
...
use_subjectID = 1;
log_filenames = {'_01', '_02', '_03', '_04', '_05', '_06', '_07', '_08', '_09', ...
                    '_10', '_11', '_12', '_13', '_14'};
...
any_code = {'31','32','33','34', ...
            '50','100'};

% Create a cell vector of names for all the different targets (i.e. stimuli after which you expect a response)
target_names = {'Nopic t1', 'Relevant t1', 'Cong t1', 'Incong t1', ... 
                'Nopic t2', 'Relevant t2', 'Cong t2', 'Incong t2'};  %, ...
                %'Nopic t3', 'Relevant t3', 'Cong t3', 'Incong t3'};
...
response_codes = {{'98', '98', '98', '98', '99', '99', '99', '99'}};
...
compound_names = {'All t1', 'All t2', 'All Cong', 'All Incong'};
compound_targets = {[1, 2, 3, 4], [5, 6, 7, 8], [3 7], [4, 8]};

% specify how long after the target responses are accepted (should usually be less than the SOA)
min_RT = 100 ;
max_RT = 1500;  % in milliseconds
